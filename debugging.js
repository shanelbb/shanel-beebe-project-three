$(function() {
  ...
  const rgbMode = function() {
    ...
    $buttons.on("click", function() {
      ...
      console.log("$(this).attr('style')" + $(this).attr("style"));

      if (this === $buttons[answerButton]) {
        console.log("this: " + this);
        console.log("answerButton: " + $buttons[answerButton]);
        console.log("score before eval: " + score);
        $answerMessage.html("Correct!");
        $background.css($(this).attr("style"));
        score++;
